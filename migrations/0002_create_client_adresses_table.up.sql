...
-- CREATE INDEX idx_addresses_geom ON client_addresses USING GIST (geom);
--
-- -- Создание уникального индекса на основе географической точки и client_id для предотвращения дублирования адресов
-- CREATE UNIQUE INDEX idx_unique_address_per_client ON client_addresses (client_id, geom);
